...
def make_objects():
    ...
    # center_x += 40
    # shape = arcade.create_ellipse_outline(center_x, center_y, width, height, arcade.color.RED, border_width=4)
    # shape_list.append(shape)
    #
    # center_x += 40
    ...
    # shape_list.append(shape)
    #
    # shape = arcade.create_line(0, 0, 80, 0, arcade.color.BLUE, line_width=4)
    # shape_list.append(shape)
    #
    ...
    # shape_list.append(shape)
    # shape = arcade.create_rectangle_outline(center_x, center_y, width, height, arcade.color.BLACK, border_width=5)
    # shape_list.append(shape)
