...
class MyTestWindow(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.character_sprite = self.character_list[0]
        self.character_sprite.center_x = 50.0
        self.character_sprite.center_y = 50.0
        self.character_sprite.change_x = 5.0
        self.character_sprite.change_y = 5.0
