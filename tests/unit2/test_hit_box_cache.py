...
def test_load_texture():
    ...
    assert Texture.hit_box_cache.get([texture.image_data.hash]) is None
    ...
    points_1 = Texture.hit_box_cache.get([texture_1.image_data.hash, "simple", 4.5])
    points_2 = Texture.hit_box_cache.get([texture_2.image_data.hash, "detailed", 4.5])
