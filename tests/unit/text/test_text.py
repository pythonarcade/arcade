...
def test_text(window):
    ...
    current_y -= LINE_HEIGHT
    arcade.draw_text(
        "Test Text Anchor Top", SCREEN_WIDTH // 2, current_y, arcade.color.BLACK, 12, anchor_y="top"
    )
    arcade.draw_point(SCREEN_WIDTH // 2, current_y, arcade.color.RED, 5)
    ...
    current_y -= LINE_HEIGHT
    arcade.draw_text(
        f"Test Text Field Width {field_width}",
        current_x,
        current_y,
        arcade.color.BLACK,
        12,
    ...
    current_y -= LINE_HEIGHT
    arcade.draw_text(
        f"Centered Test Text Field Width {field_width}",
        current_x,
        current_y,
        arcade.color.BLACK,
        12,
    ...
    arcade.draw_text(
        "Different font", current_x, current_y, arcade.color.BLACK, 12, font_name=font_name
    )
