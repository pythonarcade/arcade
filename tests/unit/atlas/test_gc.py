...
def test_gc_image_multi_ref(ctx, common):
    ...
    texture_1 = None
    common.check_internals(
        atlas, images=1, textures=5, unique_textures=5, textures_added=6, textures_removed=1
    )
    texture_2 = None
    common.check_internals(
        atlas, images=1, textures=4, unique_textures=4, textures_added=6, textures_removed=2
    )
    texture_3 = None
    common.check_internals(
        atlas, images=1, textures=3, unique_textures=3, textures_added=6, textures_removed=3
    )
    texture_4 = None
    common.check_internals(
        atlas, images=1, textures=2, unique_textures=2, textures_added=6, textures_removed=4
    )
    texture_5 = None
    common.check_internals(
        atlas, images=1, textures=1, unique_textures=1, textures_added=6, textures_removed=5
    )
    texture_6 = None
    gc.collect()
    gc.collect()
    common.check_internals(
        atlas, images=0, textures=0, unique_textures=0, textures_added=6, textures_removed=6
    )
...
def test_gc_image_multi_ref_duplicates(ctx, common):
    ...
    atlas.add(texture_2)
    common.check_internals(
        atlas, images=1, textures=2, unique_textures=2, textures_added=2, textures_removed=0
    )
    atlas.add(texture_3)
    common.check_internals(
        atlas, images=1, textures=3, unique_textures=2, textures_added=3, textures_removed=0
    )
    atlas.add(texture_4)
    common.check_internals(
        atlas, images=1, textures=4, unique_textures=3, textures_added=4, textures_removed=0
    )

    # Remove a texture one by one and check the internals
    texture_1 = None
    common.check_internals(
        atlas, images=1, textures=3, unique_textures=3, textures_added=4, textures_removed=1
    )
