...
* By default, Arcade's example resources are not included in the bundled application. If you need assets from there, you should download them and include them in your own `resources` directory as explained above.
