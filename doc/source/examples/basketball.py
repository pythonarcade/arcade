...
#this function is called repeatedly in order to draw the shapes and update their position
...
#all shapes created will require the prefix 'on_draw' in order to be accessible to the on_draw function
...
on_draw.right_arc = arcade.Arc(236, 105, 20, 15, arcade.color.BLACK, 0, 180, 1, 270)
on_draw.left_arc = arcade.Arc(236, 105, 20, 15, arcade.color.BLACK, 0, 180, 1, 90)
...
on_draw.right_arm_1 = arcade.Rectangle(210, 50, 15, 5, arcade.color.BLACK, 2, 50)
on_draw.right_arm_2 = arcade.Rectangle(220, 60, 15, 5, arcade.color.BLACK, 2, 130)
...
on_draw.shot_display = arcade.Text("Basketball", 50, 550, 50, arcade.color.PURPLE)
