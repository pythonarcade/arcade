...
def draw_bird(center_x, center_y):
    """
    Draw a bird using a couple arcs.
    """
    arcade.draw_arc_outline(center_x, center_y, 20, 20, arcade.color.BLACK, 0, 
        90)
    arcade.draw_arc_outline(center_x + 40, center_y, 20, 20, arcade.color.BLACK,
        90, 180)
