...
from arcade.gl.new import Buffer, Context, Geometry, Program
...
class GLContext(Context):
    ...
    def __init__(
        ...
        self.active_program: GLProgram | ComputeShader | None = None
    ...
    def geometry(
        ...
        * Render your geometry with indirect rendering. This means packing
        ...
        """
        assert isinstance(index_buffer, GLBuffer)
        return GLGeometry(
            self,
            content,
    ...
    def program(
        ...
        *args,
        ...
        """
        assert vertex_shader is not None
