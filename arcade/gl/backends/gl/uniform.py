...
# TODO: does this need to publicly usable? Or does all uniform interaction happen via program/context?
# Basically, do we need a protocol for this in the abstract API or can this exist solely in implementations?
class Uniform:
    """
    A Program uniform
