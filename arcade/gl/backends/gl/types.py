...
BufferOrBufferProtocol = Union[BufferProtocol, GLBuffer]
...
class BufferDescription:
    ...
    def __init__(
        ...
        self.buffer = buffer  # type: GLBuffer
        ...
        if not isinstance(buffer, GLBuffer):
            raise ValueError("buffer parameter must be an arcade.gl.backends.gl.GLBuffer")
