...
from arcade.types import Color, Point, PointList, RGBALike
...
def create_line(start_x: float, start_y: float, end_x: float, end_y: float,
                color: RGBALike, line_width: float = 1) -> Shape:
    """
...
def create_line_generic_with_colors(point_list: PointList,
                                    color_sequence: Sequence[RGBALike],
                                    shape_mode: int,
...
def create_lines_with_colors(point_list: PointList,
    ...
    :param RGBALike color_list: Three or four byte tuples list for every point
    :param float line_width:
...
def create_rectangles_filled_with_colors(point_list, color_list: Sequence[RGBALike]) -> Shape:
    """
...
def create_triangles_filled_with_colors(
        ...
        color_sequence: Sequence[RGBALike]) -> Shape:
    """
...
def create_ellipse_filled_with_colors(center_x: float, center_y: float,
                                      ...
                                      outside_color: RGBALike, inside_color: RGBALike,
    ...
    :param float width:
    :param float height:
    :param RGBALike outside_color:
    :param RGBALike inside_color:
    :param float tilt_angle:
