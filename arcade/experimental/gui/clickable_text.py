...
class ClickableText(ButtonAbstract):
    def __init__(
        ...
        text_image_normal = arcade.get_text_image(
            text=text, text_color=text_color, font_size=font_size, font_name=font_name
        )
        text_image_mouse_over = arcade.get_text_image(
            text=text,
            text_color=text_color_mouse_over,
            font_size=font_size,
            font_name=font_name,
        )
        text_image_mouse_press = arcade.get_text_image(
            text=text,
            text_color=text_color_mouse_press,
            font_size=font_size,
            font_name=font_name,
        )
        ...
        self.mouse_press_texture = arcade.Texture(
            image=text_image_mouse_press, name=text + "3"
        )
        self.mouse_over_texture = arcade.Texture(
            image=text_image_mouse_over, name=text + "6"
        )
