...
class FlatTextButton(ButtonAbstract):
    ...
    def __init__(self, text, center_x, center_y, width, height, theme: Theme):
        ...
        rect = [
            0,
            0,
            text_image_normal.width - theme.border_width / 2,
        ...
        if theme.border_color and theme.border_width:
            ...
            d.rectangle(
                rect, fill=None, outline=theme.border_color, width=theme.border_width
            )
        ...
        self.mouse_press_texture = arcade.Texture(
            image=text_image_mouse_press, name=text + "4"
        )
        self.mouse_over_texture = arcade.Texture(
            image=text_image_mouse_over, name=text + "5"
        )
