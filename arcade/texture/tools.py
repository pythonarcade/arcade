...
from arcade.types import IntPoint
...
def get_default_texture(size: IntPoint = _DEFAULT_IMAGE_SIZE) -> Texture:
    """
...
def get_default_image(size: IntPoint = _DEFAULT_IMAGE_SIZE) -> ImageData:
    """
