...
from arcade.arcade_types import RGB, Vector
...
class Sprite:
    ...
    Attributes:
        ...
        :position: A vector pymunk.Vec2d(x, y) of where the sprite is.
        :repeat_count_x:
        :repeat_count_y:
        ...
        :velocity: Change in x, y expressed as a pymunk.Vec2d. Vec2d(0, 0) would be not moving.
