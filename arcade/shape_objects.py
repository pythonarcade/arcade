...
class Line():
    ...
    def draw(self):
        draw_line(self.start_x, self.start_y, self.end_x, self.end_y, self.color, self.width)
...
class Arc():
    def __init__(self, center_x, center_y, width, height, color = arcade.color.GREEN, start_angle = 0, end_angle = 180, border_width = 0, tilt_angle = 0):
        self.center_x = center_x
        self.center_y = center_y
        self.width = width
        self.height = height
    ...
    def draw(self):
        draw_arc(self.center_x, self.center_y, self.width, self.height, self.color, self.start_angle, self.end_angle, self.border_width, self.tilt_angle)
