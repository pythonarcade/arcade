...
class Property:
    ...
    def __init__(self, default: Any=None, default_factory: Callable=None) -> None:
        ...
        self.obs: [WeakKeyDictionary[object: _Obs]] = WeakKeyDictionary()

    def _get_obs(self, instance: Any) -> _Obs:
        obs: _Obs = self.obs.get(instance)
        if obs is None:
            obs = _Obs()
    ...
    def bind(self, instance: Any, callback: Callable) -> None:
        obs: _Obs = self._get_obs(instance)
...
class _ObservableDict(dict):
    ...
    def __init__(self, prop: Property, instance: Dict, *largs: list) -> None:
...
class _ObservableList(list):
    ...
    def __init__(self, prop: Property, instance: list, *largs: list) -> None:
        self.prop: Property = prop
        self.obj = ref(instance)
        super().__init__(*largs)
...
class ListProperty(Property):
    ...
    def set(self, instance: Any, value: dict):
