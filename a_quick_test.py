...
def get_map():
    map_file = open("examples/map.csv")
    map_array = []
...
class MyApplication(arcade.Window):
    ...
    def setup(self):
        ...
        # Set up the player
        self.score = 0
        self.player_sprite = arcade.Sprite("examples/images/character.png",
                                           SPRITE_SCALING)
        ...
        for row_index, row in enumerate(map_array):
            for column_index, item in enumerate(row):
                ...
                if item == -1:
                    ...
                    wall = arcade.Sprite("examples/images/boxCrate_double.png",
                                         SPRITE_SCALING)
                elif item == 1:
                    wall = arcade.Sprite("examples/images/grassLeft.png",
                                         SPRITE_SCALING)
                elif item == 2:
                    wall = arcade.Sprite("examples/images/grassMid.png",
                                         SPRITE_SCALING)
                elif item == 3:
                    wall = arcade.Sprite("examples/images/grassRight.png",
                                         SPRITE_SCALING)
